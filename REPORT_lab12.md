...
---> От топота копыт пыль по полю летит.  ИСПРАВИЛ
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  4.осле исправления всех ошибок нажмите <ESC> для возврата в обычный режим.
...
---> Несколько словo в этом предложении излишни.                 ИСПРАВИЛ
...
---> Кто-то набрал окончание этой строки дважды.                       ИСПРАВИЛ
...
---> эта строка слов очищена.                                    ИСПРАВИЛ
...
---> Конец этой строки нуждается в помощи, команды с доллар  ИСПРАВИЛ
...
ДОБАВИЛ ТЕКСТ ВНУТРИ ПК толкьо выше
...
---> Эта стро позволит вам попрактиков в добавле текста.   ВЫПОЛНИЛ ЗАДАНИЕ
...
---> Добавление 123 к 456 даёт 579.       ВЫПОЛНИЛ ЗАДАНИЕ
...
--->  а) Этот элемент первый.
      б)  Этот элемент второй      ВЫПОЛНЕНО
